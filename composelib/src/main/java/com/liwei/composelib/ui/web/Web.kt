package com.liwei.composelib.ui.web
...
import com.liwei.composelib.ui.web.viewmodel.WebViewModel
import com.liwei.composelib.widget.TitleBar

@Composable
@Preview
fun Web(navController: NavHostController = rememberNavController(), url: String = "https://www.baidu.com" ) {
